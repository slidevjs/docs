...
export const community: ThemeInfo[] = [
  ...
  },
  {
    ...
    previews: [
      'https://cdn.jsdelivr.net/gh/alexanderdavide/slidev-theme-academic@master/example-export/01.png',
      'https://cdn.jsdelivr.net/gh/alexanderdavide/slidev-theme-academic@master/example-export/02.png',
      'https://cdn.jsdelivr.net/gh/alexanderdavide/slidev-theme-academic@master/example-export/03.png',
      'https://cdn.jsdelivr.net/gh/alexanderdavide/slidev-theme-academic@master/example-export/04.png',
      'https://cdn.jsdelivr.net/gh/alexanderdavide/slidev-theme-academic@master/example-export/05.png',
      'https://cdn.jsdelivr.net/gh/alexanderdavide/slidev-theme-academic@master/example-export/06.png',
      'https://cdn.jsdelivr.net/gh/alexanderdavide/slidev-theme-academic@master/example-export/07.png',
    ],
    tags: [
      'dark',
      'light',
