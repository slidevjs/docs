	...
	<header v-if="showHero" class="home-hero flex">
		<div
			class="
				mx-auto
				grid
				lg:grid-cols-[minmax(400px,600px),minmax(500px,800px)]
				gap-4
			"
		>
			<div class="my-auto pb-40 <md:pb-26">
				...
				<div class="description !-mt-4">
					<b>Aprese</b>ntações para <b>Desenv</b>olvedores
				...
				<NavLink
					v-if="hasAltAction"
					:item="{
						link: data.altActionLink,
						text: data.altActionText,
					}"
				...
				<div class="mt-5 flex">
					<div class="mx-auto">
						...
						<div class="language-bash mt-2">
							<pre><code><span class="opacity-50">$ </span><span class="token function">yarn create</span> <span class="token text-[#408c9e] font-500">slidev</span></code></pre>
						</div>
					</div>
				</div>
				...
				<a
					...
					class="mt-3 block filter dark:invert"
					target="__blank"
				>
					<img
						alt="GitHub stars"
						src="https://img.shields.io/github/stars/slidevjs/slidev?style=social"
					/>
				</a>
			</div>
			<ClientOnly>
...
const hasAction = computed(
	() => data.value.actionLink && data.value.actionText
);
